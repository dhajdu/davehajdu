...
const services = [
  ...
  },
  {
    ...
    body: 'Two books. One on leading in the AI era. One on the identity of the person who bridges business and technology. Both born from two decades in the gap.',
    cta: 'View the Books',
    href: '/books',
