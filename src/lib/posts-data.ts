...
export const BLOCKS_BY_SLUG: Record<string, Block[]> = {
  'leadership-now-means-leading-ai-and-people': [
    ...
    { tag: 'gallery', images: ['/images/dad-georgetown-dubai.webp'], caption: "Inside Georgetown's Executive MBA in Dubai" },
    ...
    { tag: 'gallery', images: ['/images/dad-holtom-class.webp'], caption: 'With Dr. Brooks Holtom before class' },
    ...
    { tag: 'gallery', images: ['/images/dad-the-work.webp'], caption: 'The work behind the program' },
  ...
  'leverage-yourself-first': [
    ...
    { tag: 'p', text: 'The principle I built the experiment around came from my friend <a href="https://www.facebook.com/DrJamesLMurray" target="_blank" rel="noopener noreferrer">Dr. James Murray</a>, with reinforcement from my mobility coach, <a href="https://www.facebook.com/tuan.van.519694" target="_blank" rel="noopener noreferrer">Tuan Van</a>: <strong>availability</strong>. If the good thing is easy to reach and the bad thing is hard, you\'ll do the good thing. Willpower is fragile. Environment design is durable. (Far beyond the 21-day-habit cliché in <a href="https://jamesclear.com/atomic-habits" target="_blank" rel="noopener noreferrer">Atomic Habits</a>.)' },
